...
//
// COMBO C -- a deliberately DIFFERENT lever combination from Combo A/B, not
// a strict superset. Composes three independently-proven techniques:
//
//   1. Mask-hoist (q8_dot_begin/end, shared with Combo A/B / Rehan's design)
//   2. Light single-call-per-row prefetch (Combo B, unchanged)
//   3. Batched-8 fp16 scale-convert (THIS session's own standalone lever,
...
// whole row (see Combo B for why 8 calls/row was a proven regression).
